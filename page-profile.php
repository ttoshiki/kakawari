<?php get_header(); ?>
	<main class="site-main">
      ...
      <div class="page-header">
        <h1 class="page-heading"><?php echo the_title(); ?></h1>
        <picture>
					<source srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/profile_header.webp" type="image/webp">
					<img src="<?php echo get_template_directory_uri(); ?>/dist/images/profile/profile_header.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/profile_header.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/images/home/profile_header@2x.jpg 2x " alt="" class="home__mv -fixed -pc">
				</picture>
      </div>
      <section class="profile__message">
        <div class="profile__messageContents">
          <picture class="profile__messagePicture">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/dist/images/profile/message01.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/message01.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/images/profile/message01@2x.jpg 2x " alt="" class="home__profileImage">
          </picture>
        ...
        <div class="profile__message -vertical">
      ...
      <section class="profile__profile">
        <div class="profile__profileBlock">
          <div class="profile__profile -vertical">
      ...
      <div class="profile__separation">
        <picture class="profile__profilePicture">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot02.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot02.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot02@2x.jpg 2x " alt="" class="profile__separationPolkaDot">
        </picture>
        <picture class="profile__profilePicture">
          <source srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/separation_image.webp" type="image/webp">
          <img src="<?php echo get_template_directory_uri(); ?>/dist/images/profile/separation_image.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/separation_image.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/images/profile/separation_image@2x.jpg 2x " alt="" class="profile__separationImage">
        </picture>
        <picture class="profile__profilePicture">
          <source srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot01.webp" type="image/webp">
          <img src="<?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot01.jpg" srcset="<?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot01.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/images/profile/polka_dot01@2x.jpg 2x " alt="" class="profile__separationPolkaDot">
        </picture>
      </div>
      <section class="profile__company">
        ...
        <div class="profile__companyTable">
          ...
          <dl>
            <dt>所 在 地</dt>
            <dd>〒107-0062　東京都港区南青山2-2-15 ウィン青山942</dd>
          </dl>
          <dl>
            <dt>事業内容</dt>
            <dd>
