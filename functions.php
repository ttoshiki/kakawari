...
if ( ! function_exists( 'media_wp_setup' ) ) :
	...
	function media_wp_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'main_menu', 'media_wp' ),
			'footer' => esc_html__( 'footer_menu', 'media_wp' ),
		) );
...
function media_wp_scripts() {
    ...
    wp_enqueue_script( 'main-scripts', get_template_directory_uri() . '/assets/js/main.js', array(), '', true );
